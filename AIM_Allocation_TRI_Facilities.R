...
allocation_nearby_tri_table <- nearby_tri_table

write.xlsx(nearby_tri_table,"output/Allocation Rule/tri_facilities/allocation_nearby_tri_facilities.xlsx", overwrite = TRUE)
...
plot_usmap(include=c(.northeast_region,.south_region,.north_central_region), #,.west_north_central,.west_region,.west_south_central 
  ...
  labs(size = expression("Nearby TRI Facilities \n      (within 3 miles)")) +
  theme(legend.position = c(0.85, 0.1))
ggsave("output/Allocation Rule/tri_facilities/TRI_3mi_map.png",width=11,height=8)
...
plot_usmap(include=c(.northeast_region,.south_region,.north_central_region), #,.west_north_central,.west_region,.west_south_central
  ...
  labs(size = expression("Nearby TRI Facilities \n      (within 5 miles)")) +
  theme(legend.position = c(0.85, 0.1))
ggsave("output/Allocation Rule/tri_facilities/TRI_5mi_map.png",width=11,height=8)
...
plot_usmap(include=c(.northeast_region,.south_region,.north_central_region), #,.west_north_central,.west_region,.west_south_central
  ...
  labs(size = expression("Nearby TRI Facilities \n      (within 10 miles)")) +
  theme(legend.position = c(0.85, 0.1))
ggsave("output/Allocation Rule/tri_facilities/TRI_10mi_map.png",width=11,height=8)
